...
# 03: Synthetic Bonds and Fixed Income
...
- **Variance Crush Profile:** The TWAMM-hedged architecture mathematically reduces volatility. By explicitly comparing the unhedged vs hedged variance, the strategy demonstrates a massive variance reduction (e.g. from 12.30% down to a tightly bounded 1.23% in Chaotic regimes).
