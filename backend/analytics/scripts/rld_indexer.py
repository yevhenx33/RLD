...
def main() -> int:
    ...
    fluid_ftoken_replay.add_argument("--rpc-state", action="store_true", help="Also read fToken RPC state at each replay point; default is event-only")
    ...
    fluid_ftoken_anchor.add_argument("--write-validation", action="store_true", help="Persist the validation result to fluid_rpc_validation_runs")
