...
contract TestV4LP is Script, StdCheats {
    ...
    function run() external {
        ...
        address broker =
            PrimeBrokerFactory(brokerFactory).createBroker(keccak256(abi.encode(block.timestamp, deployer, "v4lp")));
        ...
        uint128 liquidity =
            LiquidityAmounts.getLiquidityForAmounts(sqrtPriceX96, sqrtLower, sqrtUpper, wRLPForLP, aUSDCForLP);
