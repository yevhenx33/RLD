...
contract LiquidationOutOfRange is LiquidationBase {
    ...
    function test_T12_OOR_LP_Above() public {
        ...
        (PrimeBroker broker, uint256 tokenId) = _setupBrokerOOR(0, 0, 5_000e6, true);
    ...
    function test_T13_OOR_LP_Below() public {
        ...
        (PrimeBroker broker, uint256 tokenId) = _setupBrokerOOR(0, 0, 10_000e6, false);
    ...
    function test_T14_Cash_Plus_OOR_LP_Above() public {
        ...
        (PrimeBroker broker, uint256 tokenId) = _setupBrokerOOR(20_000e6, 0, 5_000e6, true);
        _liquidate(broker, tokenId, 15e18, true);
    }
    ...
    function test_T15_Cash_Plus_OOR_LP_Below() public {
        ...
        (PrimeBroker broker, uint256 tokenId) = _setupBrokerOOR(20_000e6, 0, 10_000e6, false);
        _liquidate(broker, tokenId, 15e18, true);
    }
}
