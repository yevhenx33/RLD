 ...
 */
abstract contract RLDIntegrationBase is Test, DeployPermit2 {
    ...
    /// @dev TWAMM order expiration interval (1 hour)
    uint256 constant TWAMM_EXPIRATION_INTERVAL = 3600;

    /// @dev Tick spacing for the TWAMM pool (matches production market configs)
    ...
    function setUp() public virtual {
        ...
        // ─────────────────────────────────────────────────────────────
        {
            ...
            require(
                ...
                "RLDIntegrationBase: TWAMM address mismatch"
            );
        }
