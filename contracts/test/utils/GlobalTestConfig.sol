...
contract GlobalTestConfig {
    ...
    bytes32 constant TEST_LIQ_PARAMS = bytes32((LIQ_SLOPE << 32) | (LIQ_MAX_DISCOUNT << 16) | LIQ_BASE_DISCOUNT);
    ...
    function createPositionTokenImpl() internal returns (PositionToken impl) {
        impl = new PositionToken(IMPL_TOKEN_NAME, IMPL_TOKEN_SYMBOL, IMPL_TOKEN_DECIMALS, IMPL_TOKEN_UNDERLYING);
    }
