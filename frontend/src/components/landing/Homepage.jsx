...
function LiveTicker() {
  ...
  return (
    <div className="flex items-center gap-4 mb-5 select-none" aria-hidden="true">
      {vals.map((v, i) => (
        <span key={i} className="text-[10px] text-[#2a2a2a] tracking-widest">{v}</span>
      ))}
      <span className="text-[10px] text-[#222] tracking-widest">— LIVE</span>
    </div>
  )
}
...
function HeroSection() {
  ...
  return (
    <section className="relative bg-[#050505] overflow-hidden min-h-screen flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center py-20 px-8 md:px-14 lg:ml-[120px] mb-[50px] ">
        ...
        <div className={`w-full max-w-[800px] transition-all duration-700 ${vis ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
          ...
          <div className="flex flex-wrap items-center gap-10 font-bold">
            ...
            <a
              ...
              id="cta-docs"
              className="text-[11px] tracking-[0.22em] uppercase text-[#666]
      ...
      <div className="absolute bottom-0 left-0 right-0 z-10 flex items-center justify-between px-8 md:px-14 py-3 border-t border-[#111]">
        <span className="text-[11px] tracking-[0.2em] uppercase text-[#666]">Testnet Live</span>
        <span className="text-[11px] tracking-[0.2em] uppercase text-[#666]">V.01 / Experimental Beta</span>
      </div>
    </section>
  )
}
...
function Metric({ label, value }) {
  return (
    <div className="flex items-baseline justify-between border-b border-[#141414] py-3">
      <span className="text-[10px] tracking-[0.18em] uppercase text-[#555]">{label}</span>
      <span className="text-[12px] text-[#999]">{value}</span>
    </div>
  )
}
  ...
  return (
    ...
    >
      ...
      <div className="px-8 pt-8 pb-6 flex-1">
        ...
        <p className="text-[11px] tracking-[0.08em] text-[#666] mb-8">{subtitle}</p>
      ...
      <div className="px-8 pb-8">
        <Link
          ...
          className="inline-flex items-center gap-2 px-6 py-[11px] border border-white
                     text-[10px] tracking-[0.22em] uppercase text-white
...
function UseCasesSection() {
  ...
  return (
    <section className="relative bg-[#050505]/95 min-h-screen flex flex-col justify-center px-8 md:px-14 py-20 border-t border-[#111]">
      <Grain />
      <div className="relative z-10 max-w-[1100px] mx-auto w-full">
        ...
        >
          ...
          <span className="text-[12px] tracking-[0.28em] uppercase text-[#333]">Synthetic Bonds</span>
...
function Stat({ value, label }) {
  return (
    <div className="border-l border-[#1e1e1e] pl-5">
      ...
      <div className="text-[10px] tracking-[0.18em] uppercase text-[#444]">{label}</div>
    </div>
  )
}
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between">
        <span className="text-[9px] tracking-[0.3em] text-[#252525]">0{index}</span>
        <span className="text-[8px] tracking-[0.22em] uppercase text-[#1e1e1e] border border-[#181818] px-2 py-[2px]">
          Covered
        </span>
      </div>
      ...
      <p className="text-[11px] leading-[1.85] text-[#666] flex-1">{description}</p>
  ...
  return (
    <section className="relative bg-[#050505]/95 min-h-screen flex flex-col justify-center px-8 md:px-14 py-20 border-t border-[#111]">
      ...
      <div className="relative z-10 max-w-[1100px] mx-auto w-full">
        ...
        >
          <span className="text-[#333] text-[11px]">|—</span>
          <span className="text-[12px] tracking-[0.28em] uppercase text-[#333]">Solvency Insurance</span>
          <span className="flex-1 h-px bg-[#141414]" />
        </div>
        ...
        >
          <div>
            ...
            <div className="inline-flex items-center gap-3 px-6 py-[11px] border border-[#1e1e1e] cursor-not-allowed">
              <span className="text-[10px] tracking-[0.22em] uppercase text-[#333]">Explore CDS</span>
              <span className="text-[9px] tracking-[0.2em] uppercase text-cyan-900 border border-cyan-900/40 px-1.5 py-px">Soon</span>
            </div>
          </div>
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-5">
        <span className="text-[9px] tracking-[0.28em] uppercase text-[#2a2a2a]">Borrow Rate / Time</span>
        <span className="text-[9px] tracking-[0.2em] uppercase text-[#666]">Illustrative</span>
      </div>
      ...
      <div className="flex items-center gap-6 mt-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[9px] text-[#444]">Demand spike range</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-6 h-px bg-[#333]" />
          <span className="text-[9px] text-[#333]">Baseline range</span>
        </div>
      </div>
    </div>
  )
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-4">
        <span className="text-[9px] tracking-[0.28em] text-[#999]">0{index}</span>
        <span className="text-[9px] tracking-[0.22em] uppercase text-[#999] border border-[#1a1a1a] px-2 py-[2px]">
          {label}
        </span>
      </div>
      <h3
    ...
    <section className="relative bg-[#050505]/95 min-h-screen flex flex-col justify-center px-8 md:px-14 py-20 border-t border-[#111]">
      ...
      <div className="relative z-10 max-w-[1100px] mx-auto w-full">
        ...
        >
          ...
          <span className="text-[12px] tracking-[0.28em] uppercase text-[#333]">Rate Perpetuals</span>
          <span className="flex-1 h-px bg-[#141414]" />
        </div>
...
function CoreArchitectureSection() {
  ...
  return (
    <section className="relative bg-[#050505]/95 border-t border-[#111] px-8 md:px-14">
      <Grain />
      ...
      >
        ...
        <p className="text-[12px] text-[#666] tracking-[0.06em] mb-10 max-w-[400px]">
          Testnet is live. Fix yields, trade rate movements, and insure
          solvency — entirely on-chain.
        </p>

        <div className="flex items-center gap-6 mb-20 lg:pl-[42px]">
          <Link
            to="/bonds"
            className="flex items-center gap-2 px-10 py-[13px] border border-white
                       text-[11px] tracking-[0.22em] uppercase text-white font-bold
                       hover:bg-white hover:text-black transition-all duration-200"
          >
            Launch App ↗
          </Link>
      ...
      <div className="relative z-10 border-t border-[#1e1e1e]">
        <div className="max-w-[1100px] mx-auto lg:px-0 pt-6 pb-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-6">
            <span className="text-[11px] tracking-[0.3em] uppercase text-white font-bold">RLD</span>
            <span className="text-[9px] tracking-[0.18em] uppercase text-[#888]">Ethereum Testnet</span>
            <span className="text-[9px] tracking-[0.18em] uppercase text-[#888]">V.01</span>
          </div>
          <div className="flex items-center gap-6">
            {[
              ...
              <a
                ...
                className="text-[10px] tracking-[0.15em] uppercase text-[#888] hover:text-white transition-colors duration-200"
              >
                {link.label}
              </a>
            ))}
...
export default function Homepage() {
  return (
    <div className="bg-[#080808]" style={{ fontFamily: "'JetBrains Mono', 'IBM Plex Mono', Courier New, monospace" }}>
      <HeroSection />
      <UseCasesSection />
